...
const isArtist = badges => !!(badges && badges.find(b => b.metadataBadgeRenderer.tooltip === 'Official Artist Channel'));
...
exports.getAuthor = info => {
  ...
  try {
    ...
    artist = isArtist(videoOwnerRenderer.badges);
  } catch (err) {
    // Do nothing.
  }
  try {
  ...
  try {
    ...
    let video = {
      ...
      author: {
        ...
        artist: isArtist(details.ownerBadges),
